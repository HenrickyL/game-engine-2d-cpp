...
ID3D11Device* DXGraphics::device = nullptr;                  // dispositivo gráfico
ID3D11DeviceContext* DXGraphics::context = nullptr;          // contexto do dispositivo gráfico 
D3D11_VIEWPORT DXGraphics::viewport = { 0 };                  // viewport

void DXGraphics::VSync(bool state) {
    vSync = state;
}
